...
void GENERATED_TMP_mrb_mruby_errno_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_errno_gem_final(mrb_state*);
void GENERATED_TMP_mrb_mruby_digest_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_digest_gem_final(mrb_state*);
void GENERATED_TMP_mrb_mruby_input_stream_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_input_stream_gem_final(mrb_state*);
...
void GENERATED_TMP_mrb_mruby_iijson_gem_final(mrb_state*);
void GENERATED_TMP_mrb_mruby_env_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_env_gem_final(mrb_state*);
...
void GENERATED_TMP_mrb_mruby_file_stat_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_file_stat_gem_final(mrb_state*);
...
void GENERATED_TMP_mrb_mruby_exit_gem_init(mrb_state*);
...
mrb_final_mrbgems(mrb_state *mrb) {
  GENERATED_TMP_mrb_mruby_errno_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_digest_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_input_stream_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_sprintf_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_iijson_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_env_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_pack_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_array_ext_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_dir_gem_final(mrb);
  ...
  GENERATED_TMP_mrb_mruby_file_stat_gem_final(mrb);
...
mrb_init_mrbgems(mrb_state *mrb) {
  ...
  GENERATED_TMP_mrb_mruby_digest_gem_init(mrb);
  GENERATED_TMP_mrb_mruby_input_stream_gem_init(mrb);
  GENERATED_TMP_mrb_mruby_sprintf_gem_init(mrb);
  GENERATED_TMP_mrb_mruby_iijson_gem_init(mrb);
  GENERATED_TMP_mrb_mruby_env_gem_init(mrb);
  ...
  GENERATED_TMP_mrb_mruby_file_stat_gem_init(mrb);
